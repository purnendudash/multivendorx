	...
	modal: [
		{
			...
			desc: __(
				'Select who is responsible for paying affiliate referral commissions:<strong> <br> Example setup:</strong><br>' +
					...
					'<em>(Affiliate commission is calculated on the total product price)</em>' +
					'<ul>' +
					'<li><strong>Option 1 – Admin pays affiliate:</strong><br>' +
					'Marketplace commission = (20% of $1,000) - 100 = $100<br>' +
					'Affiliate commission = $50 + 5% of $1,000 = $100<br>' +
					'Store receives = $1,000 − $200 = $800<br>' +
					'<em>(Affiliate cost is covered by the marketplace)</em></li>' +
