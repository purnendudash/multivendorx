			...
			options: [
				{
					...
					desc: __(
						'Sync the assigned recipients for the notification. Options: Store, Admin.',
						'multivendorx'
					),
				},
				{
					...
					desc: __(
						'any additional email addresses added to the notification.',
						'multivendorx'
					),
				},
				{
				...
				},
				{
					...
					desc: __(
						'Text message content sent via SMS.',
						'multivendorx'
					),
				},
				{
					...
					desc: __(
						'Notification message displayed in the system.',
						'multivendorx'
					),
				},
			],
